...
export function LetterTemplateManager({ templates, onAdd, onUpdate, onDelete }: LetterTemplateManagerProps) {
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle>Add New Letter Template</CardTitle>
          <CardDescription>
            Create reusable letter templates with Mustache variables like {`{{employeeName}}`} and {`{{caseNumber}}`}
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Existing Letter Templates</CardTitle>
          <CardDescription>Manage your letter template library</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {templates.length === 0 ? (
              <p className="text-muted-foreground text-center py-8">
                No letter templates defined yet. Create your first template above.
              </p>
            ) : (
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-6xl max-h-[90vh] flex flex-col">
          <DialogHeader>
            <DialogTitle>{editingTemplate ? "Edit Letter Template" : "Create Letter Template"}</DialogTitle>
          </DialogHeader>
          ...
          <div className="flex-1 overflow-y-auto space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                Use Mustache variables: {`{{employeeName}}, {{caseNumber}}, {{caseManager}}, {{caseType}}`}, etc.
              </p>
