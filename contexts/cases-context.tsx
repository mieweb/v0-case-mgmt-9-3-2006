...
const initialCases: Case[] = [
  {
    ...
    todos: [
      ...
      { id: "todo-ar-3", dateScheduled: getRelativeDate(1), activity: "Request medical records from provider", caseManager: "Arlene Rosario, CPDM", completed: false },
  ...
  },
  {
    ...
    todos: [
      ...
      { id: "todo-ds-3", dateScheduled: getRelativeDate(0), activity: "Process FMLA paperwork", caseManager: "Debbie Swann, RN, CCM", completed: false },
  ...
  },
  {
    ...
    todos: [
      ...
      { id: "todo-kg-5", dateScheduled: getRelativeDate(7), activity: "Review vocational assessment", caseManager: "Kate Gilligan, BSN, RN, CCM", completed: false },
  ...
  },
  {
    ...
    todos: [
      ...
      { id: "todo-ar-10", dateScheduled: getRelativeDate(4), activity: "Review physical therapy progress", caseManager: "Arlene Rosario, CPDM", completed: false },
  ...
  },
  {
    ...
    todos: [
      ...
      { id: "todo-ds-10", dateScheduled: getRelativeDate(2), activity: "Confirm post-op restrictions", caseManager: "Debbie Swann, RN, CCM", completed: false },
  ...
  },
  {
    ...
    todos: [
      ...
      { id: "todo-kg-10", dateScheduled: getRelativeDate(2), activity: "Discuss treatment options with employee", caseManager: "Kate Gilligan, BSN, RN, CCM", completed: false },
