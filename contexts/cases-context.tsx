    ...
    absences: [
      {
        ...
        status: "LWD — Last Work Date",
        statusType: "LWD",
        days: { FD: 0, LWD: 1, RWD: 0, RWDREGULARJOB: 0, OTH: 0 },
      },
      {
        id: "ada-abs-2",
        ...
        status: "RWD — Restricted Work Days",
        statusType: "RWD",
        days: { FD: 0, LWD: 0, RWD: 1, RWDREGULARJOB: 0, OTH: 0 },
      },
      {
        id: "ada-abs-3",
        effectiveDate: "2025-09-06",
        status: "FD — Full Duty (ADA Accommodation Approved)",
        statusType: "FD",
        days: { FD: 1, LWD: 0, RWD: 0, RWDREGULARJOB: 0, OTH: 0 },
      },
    ],
    diagnoses: [],
    contacts: [],
